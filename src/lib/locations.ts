// Lojistik sektörüne özel lokasyon verileri

export type LocationType = "il_ilce" | "liman" | "osb" | "serbest_bolge";
...
export const TURKEY_CITIES = [
  ...
  {
    name: "Aksaray",
    districts: ["Ağaçören", "Eskil", "Gülağaç", "Güzelyurt", "Merkez", "Ortaköy", "Sarıyahşi", "Sultanhani"],
  },
  {
    name: "Amasya",
  ...
  {
    name: "Yozgat",
    districts: ["Akdağmadeni", "Aydıncık", "Boğazlıyan", "Çandır", "Çayıralan", "Çekerek", "Kadışehri", "Merkez", "Saraykent", "Sarıkaya", "Sorgun", "Şefaatli", "Yerköy", "Yenifakılı"],
  },
  {
    name: "Zonguldak",
...
export const OSB_LIST = [
  "Gebze Organize Sanayi Bölgesi",
  "Dilovası Organize Sanayi Bölgesi",
  "Kimya Organize Sanayi Bölgesi (KOSB)",
...
export const FREE_ZONES = [
  ...
  "İstanbul Deri ve Hazır Giyim Serbest Bölgesi",
...
// İlan için lokasyon gösterimini formatla
export const formatJobLocation = (job: {
  ...
  switch (job.locationType) {
    ...
    case "liman":
      return job.portTerminal
        ? `${job.port} - ${job.portTerminal}`
        : job.port || "";
    case "osb":
      return job.osb || "";
    case "serbest_bolge":
